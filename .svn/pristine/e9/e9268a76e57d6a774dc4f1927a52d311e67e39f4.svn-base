...
<title>新建换货单 - Powered By ${systemConfig.systemName}</title>
...
<body class="input">
	<div class="body">
		<div class="inputBar">
			<h1><span class="icon">&nbsp;</span>新建换货单</h1>
		</div>
		<form id="inputForm" class="validate" action="exchange_input.action" method="post">
