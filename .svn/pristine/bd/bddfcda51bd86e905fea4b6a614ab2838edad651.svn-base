package com.ibm.sc.rs.test.generate.dto.json;
...
public class GenerateBtcOmsReceiveOrderDTOJson {
	...
	public static void main(String[] args) {
		...
		bd.setBatchNum("test-201801018-SHO140410109971");
