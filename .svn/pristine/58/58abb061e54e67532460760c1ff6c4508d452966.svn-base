...
import com.ibm.oms.service.pay.dto.MiyaPayOffLineDto;
import com.ibm.oms.service.pay.intf.OfflinePayService;
import com.miya.TcpSend;

import net.sf.json.JSONObject;
@Service
public class MiyaOfflinePayServiceImpl implements OfflinePayService{
	/**
	 * 下单支付
	 * @param jsonObj
	 * @throws Exception
	...
	public String sendPay(String jsonObj) throws Exception {
		MiyaPayOffLineDto parseObj = JSON.parseObject(jsonObj, MiyaPayOffLineDto.class);
		...
		String jsonObjData = MiyaOfflinePayServiceImpl.getJsonObjData(requsetMap);
		return jsonObjData;
	}
	/**
	 * 下单支付查询
