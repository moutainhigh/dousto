...
//if(OrderMainConstClient.OrderMain_Ordersource_WX.getCode().equals(orderMainDTO.getOrderSource())){
//	return orderMainDTO;
//	
//}
////导购代客下单，电商仓发货，业绩归属于导购所属门店  否则属于 业绩归属于门店
//if(OrderMainConstClient.OrderMain_Ordersource_DG.equals(orderMainDTO.getOrderSource())){
//	return orderMainDTO;
//}
////电商平台（天猫，京东等）下单，电商仓发货，业绩归属于电商门店（天猫店、京东店等，SAP中也是门店实体）
//if(OrderMainConstClient.OrderMain_Ordersource_BS.equals(orderMainDTO.getOrderSource())){
//	return orderMainDTO;
//}
