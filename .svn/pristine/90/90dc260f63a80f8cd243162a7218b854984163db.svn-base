...
public interface SubbmitOrderValidateService {
	...
	String POINT_MESSAGE_USE = "会员可使用积分小于页面选择积分";
	String POINT_MESSAGE_PAY_AMOUNT = "可抵用积分金额不一致";
	String POINT_MESSAGE_NONE = "此订单没有使用积分，无需验证积分";
	String POINT_MESSAGE_NONE_PAYAMOUNT = "此订单没有使用积分支付，无需验证积分支付";
