		...
		<div id="conditions" style="margin:0;padding:0;">
			...
			<table class="listTable detailTable"  style="border: 1px solid #CCCCCC;width:2200px;>
				...
				<tr>
					...
					<th width="180px">
						<span name="userName">发货时间</span>
					</th>
					<th width="180px">
						<span name="ProductNo">商品货号</span>
					</th>
					<th width="150px">
				...
				<#list pager.list as list>
					<tr ondblclick="window.open('order!view.action?orderNo=${list.orderNo}&column=${column}')">
						...
						<td>
							出库时间：<font color="#104E8B">${(list.outStoreTime)!}</font><br/>	
	 	...
	 	<table class="inputTable tabContent">
		 	...
		 	<tr>
				<td width="100%" style="padding:0">
					<textarea id="clientServiceRemark2" name="clientServiceRemark2" rows="5" style="overflow: auto ;width:98%;height:100%  padding: 0; border-width: 0px; margin-bottom: 0px; margin-top: 0px;"></textarea>
				</td>
			</tr>	
	    </table>
