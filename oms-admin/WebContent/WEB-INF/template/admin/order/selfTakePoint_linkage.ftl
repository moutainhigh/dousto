...
<select id="merchantSelect" name="selfTakePoint.pointDeliverPartnerId"  <#if isDetail || order.statusConfirm = '0807'> disabled </#if> class="selectTree">
</select>
<select id="takePointSelect" name="selfTakePoint.id"  <#if isDetail || order.statusConfirm = '0807'> disabled </#if>  class="selectTree">  
</select>
