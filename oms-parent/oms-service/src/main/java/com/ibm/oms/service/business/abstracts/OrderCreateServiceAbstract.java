...
public abstract class OrderCreateServiceAbstract extends OrderCreateServiceCommon implements OrderCreateService, OrderCreateServiceConfigService<BtcOmsReceiveOrderDTO>{
	...
	/** 上下文中的单号对应返回给btc **/
      ...
      public boolean inventoryDeduct(String orderNo) {
          ...
          InventoryLockOutputDTO output = commonUtilService.jsonPostWithTrack(orderCreateServiceCommon.getSim03(),
  	...
  	@Override
	public BtcOmsReceiveOrderDTO conifigDefaultValue(BtcOmsReceiveOrderDTO t,BtcOmsReceiveOrderOutputDTO output) {
		// 1、设置默认仓库编码
    		   ...
    		   Map<String, OrderMain> omMap = context.getOmMap();
    	        ...
    	        if(jifenPayFlag){
    	            try {
    	            	...
    	            	if(Integer.valueOf(InterfaceConst.COMMON_RESPONSE_SUCCESS_CODE.getCode()) == refundDTO.getCode()){
    	            		return true;
    	            	}else{
