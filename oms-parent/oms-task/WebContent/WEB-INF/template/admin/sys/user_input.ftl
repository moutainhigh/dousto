...
<body class="input">
	<div class="body">
		...
		<form id="inputForm" class="validate" action="<#if isAdd??>user!save.action<#else>user!update.action</#if>" method="post">
			...
			<div id="t1" >
				<#include "/WEB-INF/template/admin/sys/user_input_base.ftl" />
			</div>
			<div id="t2">
