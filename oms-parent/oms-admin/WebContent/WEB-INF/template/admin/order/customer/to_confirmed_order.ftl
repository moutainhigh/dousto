...
$().ready( function() {
	...
	var e=function(){
			$("a[href*='#']","#ctabs ul").removeClass(options.selected).each(function(){
				$($(this).attr("href")).hide();
			});
	...
	$("a[href*='#']","#ctabs ul").unbind(options.event,e).bind(options.event,e).each(function(){
			$($(this).attr("href")).hide();
	...
	<div class="body">
		...
		<form id="inputForm" class="validate" action="order!update.action" method="post">
			...
			<div id="ctabs"  class="indextab">
			    <ul class="tab">
			      <li id="tab1"><a href="#ctabs1" class="selected">ctabs1</a></li>
			      <li id="tab2"><a href="#ctabs2" >ctabs2</a></li>
			    </ul>
			    <div id="ctabs1">ctabs11111</div>
