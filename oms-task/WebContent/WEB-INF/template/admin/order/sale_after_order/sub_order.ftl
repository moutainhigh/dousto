	...
	<div class="body">
		 <div id="tabs">
		   ...
		   <div id="orderItem" style="display:block">
			<table class="inputTable tabContent">
						...
						<tr name="orderitemlist">
							...
							<td>
							  <select  id="preRefundReason_${list_index}" onchange="javascript:getRefundReasonFun(${list_index})" disabled>
							   ...
							   <input type="hidden" name="orderRetChgItemsList[${list_index}].preRefundReason"  value="${preReasonMap.get(list.reason)}" />
							</td>
							<td>
				...
				<#list orderSub.orderRetChgItems as list>
					...
					<#if (orderCategory == 'chg')>
						...
						<td>
							<input type="hidden" name="orderRetChgItemsList[${list_index}].preRefundReason" value="${preReasonMap.get(list.reason)}"/>
						  <select  id="preRefundReason_${list_index}" onchange="javascript:getRefundReasonFun(${list_index})" name="orderRetChgItemsList[${list_index}].preRefundReason" disabled>
						    <#list preRefundReasonList as preRefundReason>
								<option value="${preRefundReason.reasonNo}" <#if preRefundReason.reasonNo == preReasonMap.get(list.reason)> selected </#if>>
									${preRefundReason.reasonName}
								</option>
					...
					<tr name="orderitemlist">
						...
						-->
						<td>
						  <select  id="preRefundReason_${list_index}" onchange="javascript:getRefundReasonFun(${list_index})" name="orderRetChgItemsList[${list_index}].preRefundReason">
						    <#list preRefundReasonList as preRefundReason>
								<option value="${preRefundReason.reasonNo}" <#if preRefundReason.reasonNo == preReasonMap.get(list.reason)> selected </#if>>
									${preRefundReason.reasonName}
								</option>
			...
			<!-- 客户信息 -->
			<#include "/WEB-INF/template/admin/order/sale_after_order/detail_order_customerInfo_page.ftl">
