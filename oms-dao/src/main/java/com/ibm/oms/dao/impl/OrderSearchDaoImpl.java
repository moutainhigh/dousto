	   ...
	   if (StringUtils.isNotBlank(order.getReceiverInfo())) {
		...
		if (StringUtils.isNotBlank(order.getAddressDetail())) {
			if ("1".equals(order.getIsAddressDetail())) {
				   sb.append(" and ordersearc0_2_.ADDRESS_DETAIL like '%").append(order.getAddressDetail()).append("%'");
				
			}else if ("0".equals(order.getIsAddressDetail())) {
				   sb.append(" and ordersearc0_2_.ADDRESS_DETAIL not like '%").append(order.getAddressDetail()).append("%'");
