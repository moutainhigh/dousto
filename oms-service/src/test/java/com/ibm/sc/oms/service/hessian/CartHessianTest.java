...
//          infCart.setCartItemList(cartItemList);
          ...
          InfCart InfCartparams = commonTestUtil.genJsonObjFromFile("C:/Users/wangchao/Desktop/subbmit-order-test/shaopingcartOneproduct.json",InfCart.class);
          
          
          
          GenericResult<InfCart> cc =   bundleService.calculateShoppingCart(InfCartparams);
