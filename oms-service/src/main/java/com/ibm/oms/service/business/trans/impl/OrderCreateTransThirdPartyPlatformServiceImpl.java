 ...
 */
@Deprecated
@Service("orderCreateTransThirdPartyPlatform")
public class OrderCreateTransThirdPartyPlatformServiceImpl extends OrderCreateTransAbstract {
    ...
    //第三方平台下单 从E3同步过来
    //1、同步过来的订单：1）在线支付：支付状态：已完成，审核状态：待审核，订单总状态：待审核
    // 2)京东货到付款：支付状态：待支付，审核状态：待审核，订单总状态：待审核   
