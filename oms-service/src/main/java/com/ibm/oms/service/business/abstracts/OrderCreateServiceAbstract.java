...
public abstract class OrderCreateServiceAbstract extends OrderCreateServiceCommon implements OrderCreateService, OrderCreateServiceConfigService<BtcOmsReceiveOrderDTO>{
    ...
    //修改快递公司操作日志格式
      ...
      //在线商城默认code
      public String onlineShoppingCode = "defaultOnlineShoppingCode";
      //电商门店
      public String commerceStoreCode = "defaultcommerceStoreCode";
      ...
      public String addBlackList(String orderNo, String type) {
          OrderMain om = orderMainService.findByOrderNo(orderNo);
          String url = String.format(getMem04(), om.getMemberNo(), type);
      ...
      public boolean autoAudit(String orderNo) {
          ...
          // 自动审核功能关闭
          boolean go1 = !"1".equals(getAutoAuditSwitch());
          // 虚拟直接进入人工审核
      ...
      public boolean inventoryDeduct(String orderNo) {
          ...
          InventoryLockOutputDTO output = commonUtilService.jsonPostWithTrack(getSim03(),
      ...
      public boolean inventoryCancel(String orderNo) {
          ...
          InventoryLockOutputDTO output = commonUtilService.jsonPostWithTrack(getSim04(),
      ...
      public boolean promoResourceDeduct(BtcOmsReceiveOrderDTO orderReceiveDIO, ContextBtcOmsReceiveDTO context) {
          ...
          try {
              output = commonUtilService.jsonPostWithTrack(getPromo01(), IntfSentConst.OMS_PROMO.getCode(), cpDTO,
          ...
          if (output == null || exceptionThrown || output.getCode() == null
              ...
              context.setMsg(CommonConstService.Promo01Prefix + msg);
          }
          return true;
      }
      ...
      public boolean promoResourceAdd(String batchNum, String orderNo) {
          ...
          try {
              ...
              output = commonUtilService.jsonPostWithTrack(getPromo04(), IntfSentConst.OMS_PROMO_ADD.getCode(), input,
                      CommonOutputDTO.class, null);
          } catch (Exception e) {
              logger.info("{}", e);
              exceptionThrown = true;
          ...
          for(OrderMain omTmp : omList){
              ...
              try {
                 ...
                 //         orderNoService.getDefaultOrderSubNoByOrderNo(omTmp.getOrderNo()), CommonOutputDTO.class, null);
                  ...
                  output = commonUtilService.jsonGetWithTrack(String.format(getPromo03(), ordersubNo), IntfSentConst.OMS_PROMO_REMOVE.getCode(),CommonOutputDTO.class, null);
              } catch (Exception e) {
                  logger.info("{}", e);
                  exceptionThrown = true;
              }
      ...
      public boolean memberResourceDeduct(ContextBtcOmsReceiveDTO context) {
          ...
          if(jifenPayFlag){
              try {
                  OmsMemberRefundOutputDTO refundDTO = commonUtilService.jsonPostWithTrack(getMem02(), IntfSentConst.OMS_MEM_02.getCode(), omDTO, OmsMemberRefundOutputDTO.class, null);
          ...
          boolean exceptionThrown = false;
          try {
              output = commonUtilService.jsonPostWithTrack(getMem03(), IntfSentConst.OMS_MEM_03.getCode(), memberPayDTO,
                      CommonOutputDTO.class, null);
          } catch (Exception e) {
              logger.info("{}", e);
              exceptionThrown = true;
      ...
      public InventoryLockOutputDTO inventoryLock(String orderNo) {
          ...
          boolean exceptionThrown = false;
          try {
              output = commonUtilService.jsonPostWithTrack(getSim01(), IntfSentConst.OMS_SIM_LOCK.getCode(), rsInput,
          ...
          if (output == null) {
              ...
              output.setReturn_msg("oms:库存异常或者返回null");
          }
      ...
      public InventoryLockOutputDTO inventoryUnLockByOrderNo(String orderNo){
          ...
          InventoryLockOutputDTO output = null;
          try {
              output = commonUtilService.jsonPostWithTrack(getSim02(), IntfSentConst.OMS_SIM_UNLOCK.getCode(), rsInput,
                      InventoryLockOutputDTO.class, null);
          } catch (Exception e) {
              logger.info("{}", e);
              exceptionThrown = true;
      ...
      public InventoryResendMsgOutputDTO inventoryResendMsg(String orderItemNo) {
          ...
          try {
              output = commonUtilService.jsonPostWithTrack(getSim05(), IntfSentConst.OMS_SIM_RESEND.getCode(), rsInput,
      ...
      public SupportResendOutputDTO supportResendMsg(String orderSubNo) {
          ...
          try {
              output = commonUtilService.jsonPostWithTrack(getSup01(), IntfSentConst.OMS_SUP_RESEND.getCode(), rsInput,
      ...
      public SupportResendOutputDTO supportResend24Hours(String orderSubNo) {
          ...
          try {
              output = commonUtilService.jsonPostWithTrack(getSup01(), IntfSentConst.OMS_SUP_RESEND_24HOURS.getCode(),
      ...
      public SupportResendOutputDTO supportSendSms(String mobilePhoneNum,String intfCode, String smsModeCode){
          ...
          //发送
          try {
              output = commonUtilService.jsonPostWithTrack(getSup01(), intfCode, rsInput,SupportResendOutputDTO.class, null);
          } catch (Exception e) {
              logger.info("{}", e);
              if (output == null) {
                  output = new SupportResendOutputDTO();
      ...
      public SupportResendOutputDTO supportPostFeeRet(String orderSubNo) {
          ...
          try {
              output = commonUtilService.jsonPostWithTrack(getSup01(), IntfSentConst.CM_OMS_POST_FEE_RET.getCode(), rsInput,
                      SupportResendOutputDTO.class, null);
          } catch (Exception e) {
              logger.info("{}", e);
              if (output == null) {
      ...
      public SupportResendOutputDTO supportSendEmail(String orderNo) {
          ...
          try {
              output = commonUtilService.jsonPostWithTrack(getSup01(), IntfSentConst.OMS_SUP_SEND_EMAIL.getCode(), rsInput,
                      SupportResendOutputDTO.class, null);
          } catch (Exception e) {
              logger.info("{}", e);
              output.setCode(CommonConstService.PROCESS_FAILED);
      ...
      private boolean callLogistic(String orderNo) {
          ...
          for (OrderSub os : osList) {
              ...
              LogisticsDTO rsData = commonUtilService.jsonPostWithTrack(getLogistics01(),
      ...
      private boolean buildCombineProduct(String orderNo) {
          ...
          CombineProductDTOList output = commonUtilService.jsonPostWithTrack(getProduct01(),
  	...
  	@Override
	public BtcOmsReceiveOrderDTO conifigDefaultValue(BtcOmsReceiveOrderDTO t) {
		// 1、设置默认仓库编码
	...
	public OrderMainDTO settingMerchantBalanceDate(OrderMainDTO orderMainDTO){
		...
		if(isLs(orderMainDTO.getOrderSource())){
			...
			Date balanceDate = date.getBalanceDate();
		...
		if(isWX(orderMainDTO.getOrderSource()) || isDG(orderMainDTO.getOrderSource())){
			...
			orderMainDTO.setBalanceDate(orderTimeDate);
			//String orderTime = DateUtils.formatGeneralDateTimeFormat(new Date());
			//orderMainDTO.setOrderTime(orderTime);
	...
	public OrderMainDTO settingOrderTime(OrderMainDTO orderMainDTO){
		...
		if(OrderMainConstClient.OrderMain_Ordersource_LS.getCode().equals(orderMainDTO.getOrderSource())
		   || OrderMainConstClient.OrderMain_Ordersource_DG.equals(orderMainDTO.getOrderSource())		
	 ...
	 * @return
	 */
	public OrderMainDTO settingPerformStoreCode(OrderMainDTO orderMainDTO){
		...
		if(isWX(orderResource)){
			if(StringUtils.isEmpty(orderMainDTO.getMemberNo())){
			}
			return orderMainDTO;
		...
		//电商平台（天猫，京东等）下单，电商仓发货，业绩归属于电商门店（天猫店、京东店等，SAP中也是门店实体）
