...
public class FileUtil {
	  ...
	  public static boolean newFile(String filePathAndName, String fileContent) {
	    ...
	    try { 
	      ...
	      String fileName = new String(filePathAndName.getBytes(),"UTF-8"); 
	...
	public static void method2(String file, String conent) {
	  ...
	  public static void main(String[] args) {
		  boolean newFolder = newFolder("C:/var/dd/dfdsaf/df/dsfsa/dsfs");
		  if(newFolder){
			  newFile("C:/var/dd/dfdsaf/df/dsfsa/dsfs/ddd.log","美好的");
		  }
	}
}
